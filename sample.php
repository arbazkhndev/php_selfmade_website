...
$stmt = $conn->prepare('SELECT first_name, last_name, email, username, password FROM users WHERE username = ? LIMIT 1');
    ...
    <div class="grid-wrapper sidebar-bg bg1">
        ...
        <div class="header">
            <div class="header-bar">
                <div class="brand">
                    <a href="index.html" class="logo"><span class="text-carolina">Man</span>agementz</a>
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <!-- Example sidebar menu item for admin to view all users -->
                        ...
                        <li>
                            <a href="admin_show.php">
                                ...
                                <span class="menu-text">View All Admins</span>
                            </a>
                        </li>
                        <?php endif; ?>
                    </ul>
            ...
            <div class="row">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="caption uppercase">
                                <i class="ti-bar-chart"></i> Product Sales
                            </div>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="caption uppercase">
                                <i class="ti-pie-chart"></i> Expenses
                            </div>
                        </div>
                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col">
                                                    <input type="password" name="password"
                                                        class="form-control-plaintext" value="<?= htmlspecialchars($user['password']) ?>">
                                                </div>
                                            </div>
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="message-group d-flex flex-row mb-3">
                                            ...
                                            <div class="message-item">
                                                ...
                                                Love the theme and the admin panels quite fitting, this is a quite cozy also.
                                            </div>
                                        </div>
                                        <div class="message-group d-flex flex-row mb-3">
                                            ...
                                            <div class="message-item">
                                                ...
                                                Websites easy to navigate and is not so bad,
                                                i was recommended and i am now impressed.
                                            </div>
                                        </div>
                                        <div class="message-group d-flex flex-row">
                                            ...
                                            <div class="message-item">
                                                ...
                                                #greatwebsite, #amazingwork keep up the good work.
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
...
<!-- Theme Core JS -->
<script src="dist/js/siqtheme.js"></script>

<!-- Extra Scripts -->
<script src="assets/scripts/colors.js"></script>

<!-- Page Specific Scripts -->
<script src="assets/scripts/pages/ch_apexcharts.js"></script>
<script src="assets/scripts/pages/ch_datetime.js"></script>
<script src="assets/scripts/pages/dashboard1.js"></script>
<script src="assets/scripts/pages/fm_ckeditor_balloon.js"></script>
<script src="assets/scripts/pages/fm_ckeditor_block.js"></script>
<script src="assets/scripts/pages/fm_ckeditor_classic.js"></script>
<script src="assets/scripts/pages/fm_ckeditor_document.js"></script>
<script src="assets/scripts/pages/fm_ckeditor_inline.js"></script>
<script src="assets/scripts/pages/fm_control.js"></script>
<script src="assets/scripts/pages/pg_login.js"></script>
<script src="assets/scripts/pages/tb_datatables.js"></script>
<script src="assets/scripts/pages/ui_card.js"></script>
<script src="assets/scripts/pages/ui_modal.js"></script>
<script src="assets/scripts/pages/ui_toastr.js"></script>
...
var chartBar = new ApexCharts(document.querySelector("#product-sales-chart"), optionsBar);
chartBar.render();
...
var optionsPie = {
    ...
    series: [21, 23, 19, 14, 17, 6],
    labels: ['Rent', 'Utilities', 'Salaries', 'Supplies', 'Marketing', 'Other']
};
var chartPie = new ApexCharts(document.querySelector("#expenses-chart"), optionsPie);
chartPie.render();
</script>
<!-- END Chart Scripts -->
